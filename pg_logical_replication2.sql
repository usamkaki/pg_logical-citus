...
SELECT pglogical.create_node(node_name := 'new_prov',dsn := 'host=localhost port=5433 dbname=students');
...
SELECT pglogical.create_node(node_name := 'new_sub',dsn := 'host=localhost port=5434 dbname=students');

SELECT pglogical.create_subscription( subscription_name := 'new_subp',provider_dsn := 'host=localhost port=5433 dbname=students');
